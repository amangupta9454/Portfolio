...
const Qualification = () => {
  ...
  return (
    <div
      id="qualifications"
      className="min-h-screen md:min-h-2 relative overflow-hidden py-32 px-6 md:px-28 bg-[#0f172a] text-white font-sans z-0"
      style={{
        backgroundImage: `
    ...
    >
      ...
      <div className="text-center mb-24 relative z-10">
        <h2 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500 drop-shadow-2xl gradient-shift">
          🎓 My Qualifications
        </h2>
        ...
        <p className="text-xl text-gray-200 mt-6 tracking-wider font-light shimmer-text">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-14 z-10 relative">
        {qualifications.map((q, index) => (
          <div
            key={index}
            className={`group relative overflow-hidden border-l-4 ${q.borderColor} p-7 rounded-3xl backdrop-blur-2xl shadow-[0_10px_40px_rgba(0,0,0,0.25)] transition-all duration-500 hover:scale-[1.05] hover:shadow-[0_15px_50px_rgba(0,0,0,0.35)] card-hover`}
      ...
      <div className="mt-32 text-center z-10 relative">
        <h2 className="text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-rose-300 to-pink-500 drop-shadow-2xl gradient-shift">
          🏆 Achievement
        </h2>
        ...
        <div
          className="mx-auto mt-14 max-w-3xl backdrop-blur-2xl p-10 rounded-3xl border-l-4 border-pink-500 shadow-[0_10px_40px_rgba(0,0,0,0.25)] transition-all duration-500 hover:scale-105 hover:shadow-[0_15px_50px_rgba(0,0,0,0.35)] card-hover"
          style={{ background: 'linear-gradient(135deg, rgba(244, 114, 182, 0.2), transparent)' }}
        >
